  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="knowledge-bases/:kbId/documents" element={<DocumentList />} />
        <Route path="knowledge-bases/:kbId/documents/:docId/chunks" element={<ChunkList />} />
        <Route path="knowledge-bases/:kbId/chunks" element={<KbChunkList />} />
        <Route path="knowledge-bases/:kbId/retrieval" element={<RetrievalPage />} />
